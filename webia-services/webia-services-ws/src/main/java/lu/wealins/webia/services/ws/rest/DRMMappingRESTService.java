...
public interface DRMMappingRESTService {

	/**
	 * get drm mapping by type
	 * 
	 * @param context
	 * @param type
	 * @return
	...
	@GET
	@Path("/type/{type}")
	public List<DRMMappingDTO> getDRMMapping(@Context SecurityContext context, @PathParam("type") String type);
