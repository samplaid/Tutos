package lu.wealins.webia.services.core.service.validations.transactionform;
...
public abstract class TransactionFormValidationService implements ValidationStepService, FormDataValidationService<TransactionFormDTO> {
