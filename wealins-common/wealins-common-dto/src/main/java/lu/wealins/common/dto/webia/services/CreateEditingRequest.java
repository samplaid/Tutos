...
public class CreateEditingRequest {
	...
	private String transferIds;  // aggregation of Ids with comma ',' separation
	...
	private String fundTransactionFormIds; // aggregation of Ids with comma ',' separation
