...
/**
 * Pojo for the sap accounting extraction
 * 
 * @author xqt5q
 *
 */
public class SapAccountingRowNoEntityDTO {
	...
	public SapAccountingRowNoEntityDTO() {
		super();
	}
	
	public SapAccountingRowNoEntityDTO(String company, String piece, String currency, String pieceNb, Date accountDate, BigDecimal changeRate, String account, String accountGeneral, String debitCredit,
			BigDecimal amount, String reconciliation, String explain, String product, String countryOfProduct, String support, String fund, String origin, String statusCd, Long originId, Date calculDate) {
	...
	/**
	 * @param countryOfProduct the countryOfProduct to set
	 */
