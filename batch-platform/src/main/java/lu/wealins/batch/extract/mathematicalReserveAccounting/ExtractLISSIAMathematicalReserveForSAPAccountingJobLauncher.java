 ...
 */
@EnableScheduling
public class ExtractLISSIAMathematicalReserveForSAPAccountingJobLauncher  implements JobExecutionListener {

	Log logger = LogFactory.getLog(ExtractLISSIAMathematicalReserveForSAPAccountingJobLauncher.class);
	...
	public void beforeJob(JobExecution jobExecution) {
		synchronized(jobExecution) {
	        if(activeExecution != null && activeExecution.isRunning()) {
	          ...
	          //AbstractExtractLISSIAMathematicalReserveForSAPAccountingTaskLet.initJobParameters(jobExecution.getJobParameters());
	        }
		}
	}
