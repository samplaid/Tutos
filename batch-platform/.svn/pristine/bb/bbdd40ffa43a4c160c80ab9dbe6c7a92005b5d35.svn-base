 ...
 *
 */
public class FileChannelInterceptor extends ChannelInterceptorAdapter {

	private SuccessFileJobExecutor jobExecutor;
	...
	public void setJobExecutor(SuccessFileJobExecutor jobExecutor) {
