 ...
 */
public class SqlServerJobRepositoryFactoryBean extends AbstractJobRepositoryFactoryBean implements InitializingBean {

	protected static final Log logger = LogFactory.getLog(SqlServerJobRepositoryFactoryBean.class);
