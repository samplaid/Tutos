package lu.wealins.webia.core.service.validations.surrender;
...
public abstract class SurrenderValidationStepService implements ValidationStepService, FormDataRetriever<TransactionFormDTO> {
