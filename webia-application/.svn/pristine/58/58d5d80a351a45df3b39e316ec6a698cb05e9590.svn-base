package lu.wealins.webia.core.service.validations.withdrawal;
...
public abstract class WithdrawalValidationStepService implements ValidationStepService, FormDataRetriever<TransactionFormDTO> {
