...
exports.DEV_SERVER_PROXY_CONFIG = {
        '/esb-light': {
            target: 'http://127.0.0.1:9090/pia',
            pathRewrite: function (path, req) { return path.replace('/esb-light', '') },
            secure: false,
            logLevel: 'debug'
          },
        '/webia-application': {
        ...
        '/WebiaFront': {
          ...
          pathRewrite: function (path, req) { return path.replace('/WebiaFront', '') },
          secure: false,
          logLevel: 'debug'
        },
        '/esb-light2': {
          target: 'http://127.0.0.1:9090/pia',
          pathRewrite: function (path, req) { return path.replace('/esb-light2', '') },
          secure: false,
          logLevel: 'debug'
        },
      '/webia-application2': {
      ...
      '/WebiaFront2': {
        target: 'http://127.0.0.1:3000',
        pathRewrite: function (path, req) { return path.replace('/WebiaFront2', '') },
        secure: false,
        logLevel: 'debug'
      }
}
