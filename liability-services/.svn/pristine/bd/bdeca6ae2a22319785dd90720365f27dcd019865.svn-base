 ...
 *
 */
public class ValorizedOrderNoEntity {
	 ...
	 * @param estimatedFlag
	 */
	public ValorizedOrderNoEntity(BigDecimal id, short eventType, String isinCode, String fundCurrency, String depositAccount, Date activityDate, Date valorizationDate, BigDecimal unitsNb,
			BigDecimal amountInvestedOrDesinvested, BigDecimal price, String policyId, Short status, Short valorizedFlag, Short estimatedFlag) {
		super();
		this.id = id;
